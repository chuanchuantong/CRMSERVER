...
public class TaskController extends BaseController {
	...
	@ResponseBody
	public ResponseData revoke(CompleteTaskEntity params) {

		params.setUserId(UserUtils.getUserIdToStr());
		params.setType(CommentTypeEnum.BH.toString());
		return flowableProcessInstanceService.flowTackbacks(params);
	...
	@BussinessLog(title = "流程任务", businessType = BusinessType.REVOKE)
	@RequiresPermissions("bpm:task:stop")
	@ResponseBody
	public ResponseData stopProcessInstanceById(CompleteTaskEntity params){
		params.setUserId(UserUtils.getUserIdToStr());
		return flowableProcessInstanceService.stopProcessInstanceById(params);
	}
