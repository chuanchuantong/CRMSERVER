...
public class AppRuntimeDisplayJsonClientResource extends BaseController {
	...
	public AppRuntimeDisplayJsonClientResource() {
...
//		}
		...
		Set<String> completedActivityInstances = new HashSet<>(); //获取完成节点id
		Set<String> currentActivityinstances = new HashSet<>(); //获取当前进行中节点id
	 ...
	 *
	 * @param pojoModel 流程图
	 * @param completedElements 活动点
	 * @param currentElements 当前点
	 * @param breakpoints
