 ...
 *
 * @author: yhli
 * @date: 2020-04-29 10:02
 * @web: http://www.j2eefast.com
 * @version: 1.0.1
 */
@Slf4j
public abstract class YamlProcessors {
	private YamlProcessor.ResolutionMethod resolutionMethod = YamlProcessor.ResolutionMethod.OVERRIDE;
	 ...
	 * {@link #setDocumentMatchers(YamlProcessor.DocumentMatcher...) document matchers} abstain will
	 ...
	 * from this factory. Default is {@link YamlProcessor.ResolutionMethod#OVERRIDE}.
	 */
	 ...
	 * @see YamlProcessor.ResolutionMethod
	 */
	 ...
	 * the {@link #setDocumentMatchers(YamlProcessor.DocumentMatcher...) matchers}. If a document
	 * matches it is passed into the callback, along with its representation as Properties.
	 * Depending on the {@link #setResolutionMethod(YamlProcessor.ResolutionMethod)} not all of the
	...
	private void handleProcessError(Resource resource, IOException ex) {
		if (this.resolutionMethod != YamlProcessor.ResolutionMethod.FIRST_FOUND &&
				this.resolutionMethod != YamlProcessor.ResolutionMethod.OVERRIDE_AND_IGNORE) {
	...
	/**
	 * Status returned from {@link YamlProcessor.DocumentMatcher#matches(java.util.Properties)}.
	 */
	public enum MatchStatus {
		...
		/**
		 * Compare two {@link YamlProcessor.MatchStatus} items, returning the most specific status.
		 */
